...
CREATE TABLE Sensors (
    ...
    default_frequency DECIMAL NOT NULL CONSTRAINT positive_value CHECK (default_frequency >= 1000),
    threshold_frequency DECIMAL NOT NULL CONSTRAINT positive_value CHECK (threshold_frequency >= 1000),
