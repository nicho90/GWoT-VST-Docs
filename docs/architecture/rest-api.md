...
| <span class="blue">501</span> | `/api/users` | **DELETE** | AT, AO| |
...
| <span class="green">204</span> | `/api/users/:username/sensors` | **DELETE** | UT, AT | |
...
| <span class="green">204</span> | `/api/users/:username/thresholds` | **DELETE** | UT, AT | |
...
| <span class="green">204</span> | `/api/users/:username/subscriptions` | **DELETE** | UT, AT | |
...
| <span class="green">200</span> | `/api/sensors` | **GET** | LPA, LUA, UT, AT | `?bbox=` <br> `[(0.0, 0.0),` <br> `(0.0, 1.0),` <br> `(1.0, 1.0),` <br> `(1.0, 0.0)]` |
| <span class="green">201</span> | `/api/sensors` | **POST** | AT, AO | |
| <span class="blue">501</span> | `/api/sensors` | **DELETE** | AT, AO  | |
...
| <span class="green">204</span> | `/api/sensors/:sensor_id/measurements` | **DELETE** | LUA, UT, AT | |
...
| <span class="green">204</span> | `/api/sensors/:sensor_id/timeseries` | **DELETE** | LUA, UT, AT, AO | |
...
| <span class="blue">501</span> | `/api/service_stations` | **DELETE** | AT, AO | |
...
| <span class="blue">501</span> | `/api/emergency_stations` | **DELETE** | AT, AO | |
...
| <span class="green">200</span> | `/api/vehicles` | **GET** | PA | `?category=bike`, <br> `?category=car`, <br> etc. **optional** |
| <span class="blue">501</span> | `/api/vehicles` | **POST** | AT, AO | |
| <span class="blue">501</span> | `/api/vehicles` | **DELETE** | AT, AO | |
